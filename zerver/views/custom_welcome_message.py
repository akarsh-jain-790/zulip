...
def preview_custom_welcome_test_message(
    request: HttpRequest,
    user_profile: UserProfile,
    custom_welcome_test_message: str = REQ(str_validator=check_capped_string(max_length=1000)),
) -> HttpResponse:
    
    custom_welcome_test_message = custom_welcome_test_message.strip()
